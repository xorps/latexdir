...
let mk_NDC_11 = function
    | NDC_4_4_2(x, y, z) -> let x = Digits.create ("0" + Digits.ToString x) _5 in Option.liftT3 NDC_11 x (Some y) (Some z)
    | NDC_5_3_2(x, y, z) -> let y = Digits.create ("0" + Digits.ToString y) _4 in Option.liftT3 NDC_11 (Some x) y (Some z)
    | NDC_5_4_1(x, y, z) -> let z = Digits.create ("0" + Digits.ToString z) _2 in Option.liftT3 NDC_11 (Some x) (Some y) z
